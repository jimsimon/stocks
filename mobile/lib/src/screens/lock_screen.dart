...
class LockScreen extends StatefulWidget {
  ...
  const LockScreen({Key key, this.title, this.pinSize, this.onCodeEntered})
      : super(key: key);

  @override
  State<StatefulWidget> createState() =>
      new LockScreenState(title, pinSize, onCodeEntered);
}
...
class LockScreenState extends State<LockScreen> {
  ...
  LockScreenState(this.title, this.pinSize, this.onCodeEntered);

  @override
  Widget build(BuildContext context) {
    return new StoreConnector<AppState, LockScreenViewModel>(
        converter: (store) {
      return new LockScreenViewModel(store, context);
    }, builder: (context, LockScreenViewModel viewModel) {
      return new Center(
        child: new Column(
